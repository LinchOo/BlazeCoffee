...
class StartApp: UIViewController, URLSessionDelegate {
    ...
    override func viewDidLoad() {
        ...
        animationView?.frame = CGRect(x: 0 , y: view.bounds.height - 250, width: view.bounds.width, height: 250 )
    ...
    func switchToHomeView() {
            let homeViewController = UIHostingController(rootView: MainTabBarView())
